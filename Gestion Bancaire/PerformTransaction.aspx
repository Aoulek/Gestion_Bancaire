...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPH" runat="server">
   <style>
        body {
            background: linear-gradient(to bottom right, pink,gray);
    ...
    border-radius: 0px;
    background: linear-gradient(to bottom right, pink,gray);
    background-image: linear-gradient(to bottom right, pink,gray);
    background-image: -webkit-linear-gradient(to bottom right, pink,gray);
    ...
    <div class="transaction-form">
        ...
        <div>
            <asp:Button ID="btnSend" runat="server" Text="Send" CssClass="btn btn-send" OnClick="btnSend_Click" AutoPostBack="True" BackColor="BlueViolet" />
            <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-cancel" OnClick="btnCancel_Click" CausesValidation="false" backcolor="gray" />
        </div>
